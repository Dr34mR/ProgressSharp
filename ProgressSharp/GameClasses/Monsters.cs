...
namespace ProgressSharp.GameClasses
{
    ...
    {
        private static readonly List<string> MonsterList = new List<string>
        {
            "Anhkheg|6|chitin",
            "Ant|0|antenna",
            "Ape|4|ass",
        ...
        internal static List<Monster> GetMonsters()
        {
            var returnList = new List<Monster>();
            ...
            foreach (var item in MonsterList)
            {
                ...
                var drop = itemSplit[2];

                returnList.Add(new Monster(name, levelInt, drop));
            }
